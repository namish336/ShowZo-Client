    ...
    return (
        <div className="min-h-screen bg-[#C0C9DB] text-gray-900 pt-24 px-6 md:px-16 lg:px-36 pb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {newsItems.map((item) => (
                    <div key={item._id} className="bg-white/50 backdrop-blur-md rounded-2xl overflow-hidden hover:transform hover:scale-[1.02] transition-all duration-300 shadow-sm hover:shadow-xl border border-white/50 group">
                        ...
                        <div className="p-6">
                            ...
                            <Link to={`/news/${item._id}`} className="text-red-500 font-semibold text-sm hover:underline flex items-center gap-1 group/btn">
                                Read More
